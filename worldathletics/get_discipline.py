...
class GetDiscipline(BaseModel):
    get_discipline: Optional["GetDisciplineGetDiscipline"] = Field(
        alias="getDiscipline"
    )


class GetDisciplineGetDiscipline(BaseModel):
    id: Optional[str]
...
GetDiscipline.update_forward_refs()
GetDisciplineGetDiscipline.update_forward_refs()
