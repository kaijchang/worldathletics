...
from .get_all_schedules import GetAllSchedules
...
from .get_predictor_game_banner import GetPredictorGameBanner
from .get_predictor_game_notification import GetPredictorGameNotification
...
from .get_search_results import GetSearchResults
...
from .get_where_to_watch import GetWhereToWatch
...
class WorldAthletics(AsyncBaseClient):
    ...
    async def get_event_phase_results(
        self,
        phase_code: Union[Optional[str], UnsetType] = UNSET,
        result_rank: Union[Optional[int], UnsetType] = UNSET,
        event_id: Union[Optional[int], UnsetType] = UNSET,
        order_by: Union[Optional[eventPhaseOrderByEnum], UnsetType] = UNSET,
        order_direction: Union[Optional[OrderDirectionEnum], UnsetType] = UNSET,
        ...
        query = gql(
            """
            query GetEventPhaseResults($phaseCode: String, $resultRank: Int, $eventId: Int, $orderBy: eventPhaseOrderByEnum, $orderDirection: OrderDirectionEnum) {
              getEventPhaseResults(
                phaseCode: $phaseCode
    ...
    async def get_event_timetable(
        ...
        query = gql(
            """
            query GetEventTimetable($eventId: Int, $disciplineCode: String, $orderBy: eventPhaseOrderByEnum, $orderDirection: OrderDirectionEnum) {
              getEventTimetable(
                eventId: $eventId
                disciplineCode: $disciplineCode
                orderBy: $orderBy
    ...
    async def get_waw_event(
        ...
        circuit_type_code: Union[Optional[str], UnsetType] = UNSET,
        sub_category_name_url_slug: Union[Optional[str], UnsetType] = UNSET,
        get_next_w_a_c: Union[Optional[bool], UnsetType] = UNSET,
    ) -> GetWawEvent:
        query = gql(
            """
            query GetWawEvent($nameUrlSlug: String, $id: Int, $circuitTypeCode: String, $subCategoryNameUrlSlug: String, $getNextWAC: Boolean) {
              getWawEvent(
    ...
    async def get_search_results(
        self, query: str, start: Union[Optional[int], UnsetType] = UNSET
    ) -> GetSearchResults:
        query = gql(
            """
        ...
        variables: dict[str, object] = {"query": query, "start": start}
        response = await self.execute(query=query, variables=variables)
        data = self.get_data(response)
        return GetSearchResults.parse_obj(data)
    ...
    async def get_predictor_game_banner(
        self, event_id: Union[Optional[int], UnsetType] = UNSET
    ) -> GetPredictorGameBanner:
        query = gql(
            """
            query GetPredictorGameBanner($eventId: Int) {
              getPredictorGameBanner(eventId: $eventId) {
                id
                desktopBannerId
                desktopBannerEdited
                mobileBannerId
        ...
        response = await self.execute(query=query, variables=variables)
        data = self.get_data(response)
        return GetPredictorGameBanner.parse_obj(data)

    async def get_predictor_game_notification(
        self, event_id: Union[Optional[int], UnsetType] = UNSET
    ) -> GetPredictorGameNotification:
        query = gql(
            """
            query GetPredictorGameNotification($eventId: Int) {
              getPredictorGameNotification(eventId: $eventId) {
                id
                notificationText
        ...
        response = await self.execute(query=query, variables=variables)
        data = self.get_data(response)
        return GetPredictorGameNotification.parse_obj(data)
    ...
    async def get_where_to_watch(
        ...
        query = gql(
            """
            query GetWhereToWatch($eventId: Int) {
              getWhereToWatch(eventId: $eventId) {
                id
                introText
                bottomText
                bannerStrapline
                desktopBannerId
                desktopBannerImageEdited
                mobileBannerId
                mobileBannerImageEdited
                bannerUrl
                isLive
                eventDaysCount
                eventDaysFilledCount
                endDate
                eventLevelGeneralChannels {
                  category
                  channelId
                  logoId
                  logoFileName
        ...
        response = await self.execute(query=query, variables=variables)
        data = self.get_data(response)
        return GetWhereToWatch.parse_obj(data)

    async def get_schedule(
        self,
        event_id: Union[Optional[int], UnsetType] = UNSET,
        country_id: Union[Optional[str], UnsetType] = UNSET,
    ) -> GetSchedule:
        query = gql(
            """
            query GetSchedule($eventId: Int, $countryId: String) {
              getSchedule(eventId: $eventId, countryId: $countryId) {
                id
                countryId
                countryName
                eventId
        ...
        variables: dict[str, object] = {"eventId": event_id, "countryId": country_id}
        response = await self.execute(query=query, variables=variables)
        data = self.get_data(response)
        return GetSchedule.parse_obj(data)

    async def get_all_schedules(self) -> GetAllSchedules:
        query = gql(
            """
        ...
        response = await self.execute(query=query, variables=variables)
        data = self.get_data(response)
        return GetAllSchedules.parse_obj(data)
