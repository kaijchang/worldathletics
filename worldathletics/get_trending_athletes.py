...
class GetTrendingAthletes(BaseModel):
    get_trending_athletes: Optional[
        List[Optional["GetTrendingAthletesGetTrendingAthletes"]]
    ] = Field(alias="getTrendingAthletes")


class GetTrendingAthletesGetTrendingAthletes(BaseModel):
    id: Optional[str]
    athlete_ids: Optional[List[Optional[int]]] = Field(alias="athleteIds")
    athletes_list: Optional[
        List[Optional["GetTrendingAthletesGetTrendingAthletesAthletesList"]]
    ] = Field(alias="athletesList")
    primary_media_id: Optional[List[Optional[str]]] = Field(alias="primaryMediaId")
    primary_media: Optional[
        List[Optional["GetTrendingAthletesGetTrendingAthletesPrimaryMedia"]]
    ] = Field(alias="primaryMedia")


class GetTrendingAthletesGetTrendingAthletesAthletesList(BaseModel):
    id: Optional[int]
    ...
    primary_media: Optional[
        List[Optional["GetTrendingAthletesGetTrendingAthletesAthletesListPrimaryMedia"]]
    ] = Field(alias="primaryMedia")
...
class GetTrendingAthletesGetTrendingAthletesAthletesListPrimaryMedia(BaseModel):
    id: Optional[str]
    title: Optional[str]
...
class GetTrendingAthletesGetTrendingAthletesPrimaryMedia(BaseModel):
    id: Optional[str]
    title: Optional[str]
    s_e_o_title: Optional[str] = Field(alias="sEOTitle")
    url_slug: Optional[str] = Field(alias="urlSlug")
...
GetTrendingAthletes.update_forward_refs()
GetTrendingAthletesGetTrendingAthletes.update_forward_refs()
GetTrendingAthletesGetTrendingAthletesAthletesList.update_forward_refs()
GetTrendingAthletesGetTrendingAthletesAthletesListPrimaryMedia.update_forward_refs()
GetTrendingAthletesGetTrendingAthletesPrimaryMedia.update_forward_refs()
