...
class AsyncBaseClient:
    def __init__(
        self,
        url: str = "https://gt2rau4y6beytpdxktx26qss2a.appsync-api.eu-west-1.amazonaws.com/graphql",
        headers: Optional[Dict[str, str]] = { "x-api-key": "da2-344bv27kgnd6lpilqwwbxqz7bq", "x-amz-user-agent": "aws-amplify/3.0.2" },
