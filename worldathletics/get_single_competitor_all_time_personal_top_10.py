...
class GetSingleCompetitorAllTimePersonalTop10(BaseModel):
    get_single_competitor_all_time_personal_top_10: Optional[
...
class GetSingleCompetitorAllTimePersonalTop10GetSingleCompetitorAllTimePersonalTop10Parameters(
    ...
    all_time_personal_top_10_discipline: Optional[int] = Field(
...
GetSingleCompetitorAllTimePersonalTop10.model_rebuild()
GetSingleCompetitorAllTimePersonalTop10GetSingleCompetitorAllTimePersonalTop10.model_rebuild()
