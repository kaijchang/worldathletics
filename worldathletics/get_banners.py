...
class GetBanners(BaseModel):
    get_banners: Optional["GetBannersGetBanners"] = Field(alias="getBanners")


class GetBannersGetBanners(BaseModel):
    id: Optional[str]
    title: Optional[str]
    banner_items: Optional[List[Optional["GetBannersGetBannersBannerItems"]]] = Field(
        alias="bannerItems"
    )


class GetBannersGetBannersBannerItems(BaseModel):
    id: Optional[str]
    url: Optional[str]
    primary_media_id: Optional[List[Optional[str]]] = Field(alias="primaryMediaId")
    primary_media: Optional[
        List[Optional["GetBannersGetBannersBannerItemsPrimaryMedia"]]
    ] = Field(alias="primaryMedia")
    order: Optional[int]


class GetBannersGetBannersBannerItemsPrimaryMedia(BaseModel):
    id: Optional[str]
    title: Optional[str]
...
GetBanners.update_forward_refs()
GetBannersGetBanners.update_forward_refs()
GetBannersGetBannersBannerItems.update_forward_refs()
GetBannersGetBannersBannerItemsPrimaryMedia.update_forward_refs()
