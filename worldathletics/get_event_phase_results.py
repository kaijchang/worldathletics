...
class GetEventPhaseResults(BaseModel):
    get_event_phase_results: Optional[
        List[Optional["GetEventPhaseResultsGetEventPhaseResults"]]
    ] = Field(alias="getEventPhaseResults")


class GetEventPhaseResultsGetEventPhaseResults(BaseModel):
    id: Optional[int]
    ...
    discipline: Optional["GetEventPhaseResultsGetEventPhaseResultsDiscipline"]
    ...
    result: Optional["GetEventPhaseResultsGetEventPhaseResultsResult"]


class GetEventPhaseResultsGetEventPhaseResultsDiscipline(BaseModel):
    updated_on: Optional[Any] = Field(alias="updatedOn")
    hash: Optional[str]
...
class GetEventPhaseResultsGetEventPhaseResultsResult(BaseModel):
    id: Optional[int]
    updated_on: Optional[Any] = Field(alias="updatedOn")
    ...
    discipline: Optional["GetEventPhaseResultsGetEventPhaseResultsResultDiscipline"]
...
class GetEventPhaseResultsGetEventPhaseResultsResultDiscipline(BaseModel):
    updated_on: Optional[Any] = Field(alias="updatedOn")
    hash: Optional[str]
    id: Optional[str] = Field(alias="_id")
    name: Optional[str]
...
GetEventPhaseResults.update_forward_refs()
GetEventPhaseResultsGetEventPhaseResults.update_forward_refs()
GetEventPhaseResultsGetEventPhaseResultsDiscipline.update_forward_refs()
GetEventPhaseResultsGetEventPhaseResultsResult.update_forward_refs()
GetEventPhaseResultsGetEventPhaseResultsResultDiscipline.update_forward_refs()
