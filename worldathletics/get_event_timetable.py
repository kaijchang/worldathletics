...
class GetEventTimetable(BaseModel):
    get_event_timetable: Optional[
        List[Optional["GetEventTimetableGetEventTimetable"]]
    ] = Field(alias="getEventTimetable")


class GetEventTimetableGetEventTimetable(BaseModel):
    id: Optional[int]
    ...
    discipline: Optional["GetEventTimetableGetEventTimetableDiscipline"]
...
class GetEventTimetableGetEventTimetableDiscipline(BaseModel):
    updated_on: Optional[Any] = Field(alias="updatedOn")
    hash: Optional[str]
...
GetEventTimetable.model_rebuild()
GetEventTimetableGetEventTimetable.model_rebuild()
